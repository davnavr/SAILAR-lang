...
internal unsafe static class Identifier {
    ...
    internal static extern Opaque* Create(char* contents, nuint count, ref Error.Opaque* error);
    ...
    internal static extern byte* GetContents(Opaque* identifier, ref nuint length);
}
